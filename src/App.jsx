...
import { Signup, Login, salt, getCategoriesFromServer, getMessagesFromChannel, getChannelsFromCategory, updateMessagesFromInput } from './auth';
...
function App() {
    ...
    useEffect(() => {
        ...
        const fetchData = async () => { await updateMessagesFromInput(setMessageUpdate, setRetrievalFlag, retrievalFlag, login.username, selectedServer, selectedChannel, messageUpdate)}
        fetchData();
    }, [messageUpdate])
